...
- type: experimental live paper-trading observation gate
- command: `python -m examples.btc_observer_gate.run_main --live`
- UI command: `python -m examples.btc_observer_gate.server`
- surface:
  [README.md](btc_observer_gate/README.md),
  [summary.json](btc_observer_gate/outputs/summary.json)
